...
export default function HackathonUserProfile({
  ...
  const { hackathonUserProfiles, loading: userProfileLoading, error: userProfileError } = useGetHackathonUserProfilesByEventId(eventId || '');
  ...
  if (userProfileError || !hackathonUserProfiles) return <p className="p-4 text-red-500">Error loading profile.</p>;
