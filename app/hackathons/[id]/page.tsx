...
export default function HackathonDetailsPage() {
  ...
  useEffect(() => {
    ...
    const fetchedHackathon = mockHackathonDetails.find(
      (h) => h.id === hackathonId
    );
  ...
  if (isLoading) {
    return (
      <div
        className={`flex h-screen items-center justify-center ${isDark ? 'bg-zinc-900/40' : 'bg-white'}`}
      >
  ...
  return (
    <div
      className={`flex min-h-screen ${isDark ? 'bg-zinc-900/40' : 'bg-white'}`}
    >
          ...
          <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <nav className="flex" aria-label="Breadcrumb">
              <ol className="flex items-center space-x-2">
                ...
                <li>
                  <svg
                    className={`w-4 h-4 ${isDark ? 'text-zinc-600' : 'text-gray-400'}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
...
const mockHackathonDetails: HackathonDetail[] = [
  {
    ...
    status: 'open',
    description:
      'HackTX is the largest hackathon in Texas, bringing together over 1,000 students for a weekend of innovation, creativity, and learning. Join us for 24 hours of coding, workshops, and networking with industry professionals. Whether you&apos;re a coding newbie or a hackathon veteran, HackTX has something for everyone!',
    requirements:
      'Participants must be currently enrolled in a college or university. High school students are also welcome to apply. All skill levels are welcome!',
    eligibility:
      'Open to all university students. You must be at least 18 years old or have parental consent.',
    resources: [
    ...
    faq: [
      {
        ...
        answer:
          'No prior coding experience is necessary! We welcome students of all skill levels and backgrounds.',
      },
      {
        question: 'What should I bring?',
        answer:
          'Bring your laptop, charger, student ID, and any other items you&apos;ll need for an overnight stay.',
      },
    ],
  ...
  },
  {
    ...
    status: 'open',
    description:
      'CalHacks is UC Berkeley&apos;s premier hackathon, bringing together the most creative and innovative students from around the world. With a focus on tackling real-world problems through technology, CalHacks offers participants the opportunity to develop groundbreaking solutions while connecting with industry leaders and like-minded peers.',
    requirements:
      'All university students are welcome. You&apos;ll need to bring your own laptop and any hardware you plan to use.',
    eligibility:
      'Open to all university students globally. You must be at least 18 years old.',
    resources: [
  ...
  },
  {
    ...
    status: 'open',
    description:
      'Hack the North is Canada&apos;s biggest hackathon, bringing together 1,000+ students from around the world for 36 hours of creation, innovation, and learning. Located at the University of Waterloo, this event offers a unique opportunity to collaborate with peers, learn from industry experts, and build something amazing from scratch.',
    requirements:
      'Open to all students globally. You&apos;ll need to arrange your own travel to Waterloo, Canada.',
    eligibility:
      'Students from any educational institution worldwide. You must be at least 18 years old or have guardian permission.',
    resources: [
