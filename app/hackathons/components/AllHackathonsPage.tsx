...
const mockHackathons: Hackathon[] = [
  {
    ...
    status: 'Upcoming',
    description:
      'Cal Hacks is a leading collegiate hackathon in the world, bringing together student developers and designers from across the country.',
    level: 'INTERMEDIATE',
  },
  {
    id: 2,
    ...
    status: 'Upcoming',
    description:
      "Canada's biggest hackathon, bringing together 1,000+ students from around the world for 36 hours of creation, innovation, and learning.",
    level: 'BEGINNER',
  },
  {
    id: 3,
    ...
    status: 'Open',
    description:
      'HackMIT is a weekend-long event where students from around the world come together to turn their ideas into reality.',
    level: 'ADVANCED',
  },
  {
    id: 4,
    ...
    status: 'Coming Soon',
    description:
      "TreeHacks is Stanford University's premier hackathon, bringing together over 1,000 hackers from around the world.",
    level: 'BEGINNER',
  },
  {
    id: 5,
    ...
    status: 'Open',
    description:
      'HackHarvard is an annual hackathon hosted at Harvard University, bringing together students to solve real-world problems.',
    level: 'INTERMEDIATE',
  },
  {
    id: 6,
    ...
    status: 'Upcoming',
    description:
      'PennApps is the original college hackathon, bringing together students from around the world for a weekend of innovation.',
    level: 'ADVANCED',
  },
];
...
const uniqueOrganizers = [
  ...new Set(mockHackathons.map((hackathon) => hackathon.organizer.name)),
];

// Get unique tech tags for filter
const uniqueTechTags = [
...
export default function AllHackathonsPage() {
  ...
  const filteredHackathons = mockHackathons.filter((hackathon) => {
    ...
    // Match level filter
    const matchesLevel =
      selectedLevel === '' || hackathon.level === selectedLevel;

    // Match organizer filter
    const matchesOrganizer =
      selectedOrganizer === '' ||
      hackathon.organizer.name === selectedOrganizer;
  ...
  return (
    <div
      className={`flex h-screen ${isDarkMode ? 'bg-zinc-900/40' : 'bg-white'}`}
    >
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <h1
              className={`text-3xl font-extrabold ${isDarkMode ? 'text-white' : 'text-theme-primary'}`}
            >
              All Hackathons
            </h1>
            <p
              className={`text-lg mt-2 ${isDarkMode ? 'text-zinc-400' : 'text-gray-600'}`}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredHackathons.length > 0 ? (
              ...
              <div
                className={`col-span-full text-center py-12 ${isDarkMode ? 'text-zinc-400' : 'text-gray-600'}`}
              >
