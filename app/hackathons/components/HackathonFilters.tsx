  ...
  useEffect(() => {
    function handleClickOutside(event: MouseEvent) {
      ...
      if (
        ...
        !event
          .composedPath()
          .some((el) => (el as HTMLElement)?.dataset?.filtersToggle === 'true')
      ) {
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="relative flex-grow max-w-md">
          ...
          />
          <div
            className={`absolute left-3 top-2.5 ${isDarkMode ? 'text-zinc-500' : 'text-gray-400'}`}
          >
            <SearchIcon />
          </div>
        </div>
      ...
      {showFiltersPanel && (
        ...
        >
          <div className="flex flex-col space-y-5">
            ...
            <div>
              <h4
                className={`text-sm font-medium mb-3 ${isDarkMode ? 'text-zinc-300' : 'text-gray-700'}`}
              >
                Tech Stack
              </h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <h4
                  className={`text-sm font-medium mb-2 ${isDarkMode ? 'text-zinc-300' : 'text-gray-700'}`}
                >
                  Experience Level
                </h4>
                <select
